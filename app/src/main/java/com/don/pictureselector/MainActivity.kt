...
import com.don.pictureselector.ui.PictureListActivity
import com.jd.monitor.sdk.foundation.utils.ANE
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fab.setOnClickListener { view ->
            startActivity(Intent(this, PictureListActivity::class.java))
        }
